...
<table><tr>
    <td>All platforms:</td>
    <td>
      <a href="https://github.com/conda-forge/r-rsconnect-feedstock/actions/workflows/conda-build.yml">
        <img src="https://github.com/conda-forge/r-rsconnect-feedstock/actions/workflows/conda-build.yml/badge.svg?event=push&branch=main">
      </a>
    </td>
  </tr>
</table>
...
pixi add r-rsconnect
# for installing globally
pixi global install r-rsconnect
```
...
It is possible to list all of the versions of `r-rsconnect` available on your platform:
...
```
pixi search r-rsconnect --channel conda-forge
```
